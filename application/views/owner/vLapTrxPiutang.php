                        ...
                        <div class="col-6">
                            <div class="card card-primary card-outline">
                                <div class="card-header p-2">
                                    <h3 class="card-title">Transaksi Pembayaran Piutang </h3>
                                </div> <!-- /.card-body -->
                                <div class="card-body p-2">
                                    <form action="<?= base_url("owner/Cpiutang/lapTrxPiutangShowlist/"); ?>"
                                        class="form_submit " method="post">
                                        <div class="row">
                                            <div class="col">
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-primary">
                                <div class="card-header p-1">
                                    <h3 class="card-title">Laporan Pembayaran Piutang</h3><br>
                                        ...
                                        <table id="list_lap_bar"
                                            ...
                                            <tbody>
                                                ...
                                                if (count($ptg_bayars) > 0) {
                                                    ...
                                                    foreach ($ptg_bayars as $key => $trx) {

                                                      
                                                ?>
                                                <tr role="row" class="baris_data"
                                                    data-idnota="<?= $trx->id_hutang_piutang; ?>">
                                                    <td><?= $no; ?></td>
                                                    <td><?= $trx->id_hutang_piutang ?></td>
                                                    <td><?= $trx->no_urut ?></td>
                                                    <td><?= $trx->id_sup_cust."-".$trx->nama_sup_cust; ?></td>
                                                    <td class="text-right"><?= number_format($trx->nom_hutang); ?>
                                                    </td>
                                                    <td class="text-right"><?= number_format($trx->nom_sisa_sebelum); ?>
                                                    </td>
                                                    <td class="text-right"><?= number_format($trx->nom_bayar); ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?= number_format($trx->nom_sisa_sebelum - $trx->nom_bayar ); ?>
                                                    </td>
                                                </tr>
                                                <?php

                                                        $no++;
                                                        $tot_bayar = $tot_bayar + $trx->nom_bayar;
